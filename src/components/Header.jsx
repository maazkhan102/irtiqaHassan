    ...
    <header className="absolute w-full">
      <nav aria-label="Global" className="mx-auto flex items-center justify-between p-3 lg:px-8">
        ...
        <a href="https://irtiqahassan.com/" className="text-[13px] font-normal text-white">
              ...
              <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                {callsToAction.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-normal text-white hover:bg-gray-100"
                  >
          ...
          <a href="https://irtiqahassan.com/pages/brand-partners" className="text-[13px] font-normal text-white">
            BRAND PARTNERS
          </a>
          <a href="https://irtiqahassan.com/pages/contact" className="text-[13px] font-normal text-white">
            CONTACT
          </a>
        </PopoverGroup>
        <div className=''>
